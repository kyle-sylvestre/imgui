...
struct ImSpan
{
    ...
    inline ImSpan(T* d, int sz)                     { Data = d; DataEnd = d + sz; }
    inline ImSpan(T* d, T* data_end)                { Data = d; DataEnd = data_end; }

    inline void         set(T* d, int sz)           { Data = d; DataEnd = d + sz; }
    inline void         set(T* d, T* data_end)      { Data = d; DataEnd = data_end; }
